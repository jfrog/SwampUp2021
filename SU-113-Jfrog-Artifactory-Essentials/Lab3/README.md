...
- SRE repository Permission
  - Create another permission "docker-prod-permission" for the 'SRE' group with the ability to deploy to the 'swampup-docker-prod-local' repository and save. In our case, we have given Read, Annotate, Deploy/Cache, Delete/Overwrite permissions to our SRE team
